...
-- Saggin Chair Start ( Sorry they are not in order Pairs suck )
...
Config.StageCoach = {
	...
	["STAGECOACH001X"] = {
        name = "Boles Overland Medium Coach",
        price = 25,
		type = "cash",
		rep = 60,
		icon = "fa-solid fa-circle-arrow-right",
...
Config.AddedRep = math.random(1,2) -- Every completed mission you earn this much rep
Config.ServiceFee = 25 -- If you change this you must change all the prices to match
Config.RewardMultiplier = 10 -- Miles * 10

-- Level System REP req for each level
Config.RepLevelOne = 1
Config.RepLevelTwo = 3
Config.RepLevelThree = 5
Config.RepLevelFour = 12
Config.RepLevelFive = 20
Config.RepLevelSix = 30
Config.RepLevelSeven = 50
Config.RepLevelEight = 100
Config.RepLevelNine = 150
